...
public class ScoreDisplay : MonoBehaviour {
    ...
    private void Start() {
            ...
            scoreMat.SetColor("_FaceColor", mimontMat.GetColor("_Color"));
            timeMat.SetColor("_FaceColor", newGameMat.GetColor("_Color"));
    }
    ...
    private void UpdateScore()
        {
            ...
            uniqueColors = ringManager.capturedColors.Distinct().ToList();
    ...
    private IEnumerator LerpColor(Material mat, Color newCol)
        {
            ...
            var _oldCol = mat.GetColor("_FaceColor");
            ...
            while (_timeValue < 1)
            {
                ...
                mat.SetColor("_FaceColor", _newCol);
